...
namespace Launcher
{
    public class UpdateCheck
    {
        ...
        public void Execute(LauncherPrefs.ReleaseType releaseType)
        {
            string url = "";
            ...
            {
                usableUrls.Add((url+(match.Value.Substring(2, (match.Value).Length - 3).Split('/').Last())), int.Parse(match.Value.Split('_').Last().Split('.').First()));
            }
            ...
            {
                UpgradingWindow = new UpgradingWindow();
